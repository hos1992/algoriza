<script setup>
import FromWrapper from "@/Layouts/Dashboard/FromWrapper.vue";
import FormBuilder from "@/Components/Dashboard/Forms/FromBuilder.vue";
import {computed} from "vue";
import ImageModal from "@/Components/Dashboard/Modals/ImageModal.vue";

let formRows = computed(() => {
    return [
        [
            {
                name: 'name',
        ...
        [

            {
                ...
                type: 'image',
                label: 'صورة',
                value: '/dashboard/assets/img/avatars/avatar_default_sm.png',
            },
...
<template>
    ...
    <div id="sc-page-content">
        ...
        <FromWrapper form-title="إضافة جديد">
        ...
        <!--        <div class="uk-child-width-1-5@xl uk-child-width-1-3@l uk-child-width-1-2@s uk-grid-match" data-uk-grid-->
        <!--             data-uk-sortable>-->
        <!--            <div>-->
        ...
        <!--            </div>-->
        <!--        </div>-->
        <!--        <div class="uk-child-width-1-4@xl uk-child-width-1-2@s sc-sequence-show-manual" data-uk-grid-->
        <!--             data-sc-sequence-show='{ "target": ".uk-card" }'>-->
        <!--            <div>-->
        ...
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                    <div class="sc-chart sc-chart-widget sc-js-chart-widget"-->
        <!--                         data-chart-data="[120, 60, 400, 150, 390, 35]" data-chart-color="#E53935"></div>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div>-->
        <!--                <div class="uk-card sc-widget">-->
        ...
        <!--                            </div>-->
        <!--                            <div>-->
        <!--                                <span class="sc-widget-addon md-color-blue-grey-600"><i-->
        <!--                                    class="mdi mdi-comment-text-multiple-outline"></i></span>-->
        <!--                            </div>-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                    <div class="sc-chart sc-chart-widget sc-js-chart-widget" data-chart-data="[3, 16, 12, 0, 32, 18, 4]"-->
        <!--                         data-chart-x="-,7,d" data-chart-color="#F9A825"></div>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div>-->
        <!--                <div class="uk-card sc-widget">-->
        ...
        <!--                    </div>-->
        <!--                    <div class="sc-chart sc-chart-widget sc-js-chart-widget"-->
        <!--                         data-chart-data="[12000, 26000, 10000, 15000, 12000, 50000]" data-chart-color="#03A9F4"></div>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div>-->
        <!--                <div class="uk-card sc-widget">-->
        ...
        <!--                    </div>-->
        <!--                    <div class="sc-chart sc-chart-widget sc-js-chart-widget"-->
        <!--                         data-chart-data="[120, 40, 210, 360, 510, 242]" data-chart-color="#7CB342"></div>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--        <div data-uk-grid>-->
        ...
        <!--                                <div-->
        <!--                                    class="sc-chart uk-flex uk-flex-center sc-js-traffic-sources sc-sequence-show sc-sequence-show-manual"-->
        <!--                                    style="animation-delay: 200ms;-webkit-animation-delay: 200ms"></div>-->
        <!--                            </div>-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                    <div>-->
        ...
        <!--                            <div class="uk-card-body" dir="ltr">-->
        <!--                                <div-->
        <!--                                    class="sc-chart uk-flex uk-flex-center sc-chart-labels sc-js-best-sellers sc-sequence-show sc-sequence-show-manual"-->
        <!--                                    style="animation-delay: 400ms;-webkit-animation-delay: 400ms"></div>-->
        <!--                            </div>-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                </div>-->
        ...
        <!--                                    <time datetime="2018-01-01">Jan 01, 2018</time>-->
        <!--                                    - -->
        ...
        <!--                            <table-->
        <!--                                class="uk-table uk-table-divider uk-table-striped uk-table-hover uk-table-middle sc-js-map-table uk-margin-remove">-->
        <!--                                <thead>-->
        <!--                                <tr>-->
        <!--                                    <th></th>-->
        <!--                                    <th>Country</th>-->
        ...
        <!--                                <tbody>-->
        <!--                                <tr data-region="br">-->
        <!--                                    <td class="uk-table-shrink sc-padding-right"><span class="flag flag-br"></span></td>-->
        <!--                                    <td><strong>Brasil</strong></td>-->
        <!--                                    <td class="uk-text-nowrap">18 270</td>-->
        <!--                                    <td class="uk-text-nowrap">34 748</td>-->
        <!--                                    <td class="uk-text-nowrap">35 300</td>-->
        <!--                                    <td class="uk-text-nowrap">3 281</td>-->
        <!--                                    <td class="uk-text-nowrap">38 942</td>-->
        <!--                                    <td class="uk-text-nowrap">5 586</td>-->
        <!--                                </tr>-->
        <!--                                <tr data-region="us">-->
        <!--                                    <td class="uk-table-shrink sc-padding-right"><span class="flag flag-us"></span></td>-->
        <!--                                    <td><strong>USA</strong></td>-->
        <!--                                    <td class="uk-text-nowrap">25 235</td>-->
        <!--                                    <td class="uk-text-nowrap">47 111</td>-->
        <!--                                    <td class="uk-text-nowrap">43 156</td>-->
        <!--                                    <td class="uk-text-nowrap">42 793</td>-->
        <!--                                    <td class="uk-text-nowrap">18 326</td>-->
        <!--                                    <td class="uk-text-nowrap">46 810</td>-->
        <!--                                </tr>-->
        <!--                                <tr data-region="pl">-->
        <!--                                    <td class="uk-table-shrink sc-padding-right"><span class="flag flag-pl"></span></td>-->
        <!--                                    <td><strong>Poland</strong></td>-->
        <!--                                    <td class="uk-text-nowrap">5 010</td>-->
        <!--                                    <td class="uk-text-nowrap">8 570</td>-->
        <!--                                    <td class="uk-text-nowrap">1 674</td>-->
        <!--                                    <td class="uk-text-nowrap">8 416</td>-->
        <!--                                    <td class="uk-text-nowrap">2 745</td>-->
        <!--                                    <td class="uk-text-nowrap">5 798</td>-->
        <!--                                </tr>-->
        <!--                                <tr data-region="au">-->
        <!--                                    <td class="uk-table-shrink sc-padding-right"><span class="flag flag-au"></span></td>-->
        <!--                                    <td><strong>Australia</strong></td>-->
        <!--                                    <td class="uk-text-nowrap">8 307</td>-->
        <!--                                    <td class="uk-text-nowrap">6 631</td>-->
        <!--                                    <td class="uk-text-nowrap">21 671</td>-->
        <!--                                    <td class="uk-text-nowrap">29 414</td>-->
        <!--                                    <td class="uk-text-nowrap">27 045</td>-->
        <!--                                    <td class="uk-text-nowrap">24 103</td>-->
        <!--                                </tr>-->
        <!--                                <tr data-region="cn">-->
        <!--                                    <td class="uk-table-shrink sc-padding-right"><span class="flag flag-cn"></span></td>-->
        <!--                                    <td><strong>China</strong></td>-->
        <!--                                    <td class="uk-text-nowrap">76 647</td>-->
        <!--                                    <td class="uk-text-nowrap">85 176</td>-->
        <!--                                    <td class="uk-text-nowrap">31 067</td>-->
        <!--                                    <td class="uk-text-nowrap">47 797</td>-->
        <!--                                    <td class="uk-text-nowrap">60 135</td>-->
        <!--                                    <td class="uk-text-nowrap">20 348</td>-->
        <!--                                </tr>-->
        <!--                                </tbody>-->
        <!--                            </table>-->
        <!--                        </div>-->
        ...
        <!--            </div>-->
        <!--        </div>-->
        <!--        <div class="uk-child-width-1-3@l uk-child-width-1-2@m uk-grid-match" data-uk-grid-->
        <!--             data-uk-height-match="target: > div > div > .uk-card-header > div">-->
        <!--            <div>-->
        <!--                <div class="uk-card">-->
        <!--                    <div class="uk-card-header">-->
        <!--                        <div class="uk-flex uk-flex-middle">-->
        ...
        <!--                                        <div class="uk-flex uk-flex-middle">-->
        <!--                                            <div class="uk-flex-1">-->
        <!--                                                <label for="todo-item-1">Pay electricity bill-->
        <!--                                                    <span>$248.00 (25/11/2018)</span></label>-->
        <!--                                            </div>-->
        <!--                                            <span-->
        <!--                                                class="uk-label md-bg-grey-600 uk-margin-small-right sc-flex-no-shrink">Other</span>-->
        <!--                                        </div>-->
        <!--                                    </div>-->
        <!--                                </li>-->
        <!--                                <li class="sc-list-group">-->
        ...
        <!--                                                <i class="mdi mdi-airplane sc-icon-24 uk-margin-small-left"></i>-->
        <!--                                                <label for="todo-item-2">Book flight to Dublin</label>-->
        <!--                                            </div>-->
        <!--                                            <span-->
        <!--                                                class="uk-label md-bg-green-400 uk-margin-small-right sc-flex-no-shrink">Family</span>-->
        <!--                                        </div>-->
        <!--                                    </div>-->
        <!--                                </li>-->
        <!--                                <li class="sc-list-group">-->
        ...
        <!--                                                <label for="todo-item-3">Call <strong>Ewald McKenzie</strong><span>Short descriprtion&hellip;</span></label>-->
        <!--                                            </div>-->
        <!--                                            <span-->
        <!--                                                class="uk-label md-bg-blue-400 uk-margin-small-right sc-flex-no-shrink">Work</span>-->
        <!--                                        </div>-->
        <!--                                    </div>-->
        <!--                                </li>-->
        <!--                                <li class="sc-list-group">-->
        ...
        <!--                                            </div>-->
        <!--                                            <span-->
        <!--                                                class="uk-label md-bg-red-400 uk-margin-small-right sc-flex-no-shrink">Important</span>-->
        <!--                                        </div>-->
        <!--                                    </div>-->
        <!--                                </li>-->
        <!--                                <li class="sc-list-group">-->
        ...
        <!--                                        <div class="uk-flex uk-flex-middle">-->
        <!--                                            <div class="uk-flex-1 uk-text-truncate">-->
        <!--                                                <label for="todo-item-5">Email team for updates <span>BCC: beahan.santina@yahoo.com</span></label>-->
        <!--                                            </div>-->
        <!--                                            <span-->
        <!--                                                class="uk-badge md-bg-blue-400 uk-margin-small-right sc-flex-no-shrink">Work</span>-->
        <!--                                        </div>-->
        <!--                                    </div>-->
        <!--                                </li>-->
        <!--                            </ul>-->
        ...
        <!--                            <div class="sc-progress uk-margin-medium-top sc-progress-small">-->
        <!--                                <span class="sc-progress-label"><span class="uk-text-center uk-display-inline-block"-->
        <!--                                                                      style="width: 64%">64%</span></span>-->
        ...
        <!--                                <div class="sc-progress-bar md-bg-light-green-600 uk-text-center" style="width:65%">-->
        <!--                                    Completed-->
        <!--                                </div>-->
        <!--                                <div class="sc-progress-bar md-bg-grey-600 uk-text-center" style="width:20%">Pending-->
        <!--                                </div>-->
        ...
        <!--                            <p class="uk-margin-remove-bottom uk-margin-small-top">Lorem ipsum dolor sit amet,-->
        <!--                                consectetur adipisicing elit. Expedita, tenetur...</p>-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--            </div>-->
